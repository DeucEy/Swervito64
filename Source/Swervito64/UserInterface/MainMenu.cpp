...
#include <Swervito64\UserInterface\About.h>
#include <commdlg.h>
#include <windows.h>
...
void CMainMenu::OnSaveAs(HWND hWnd)
{
    ...
    openfilename.lpstrFilter = L"Swervito64 saves (*.zip, *.pj)\0*.pj?;*.pj;*.zip;";
...
void CMainMenu::OnLoadState(HWND hWnd)
{
    ...
    CPath SaveFile;
    const char * Filter = "Swervito64 saves (*.zip, *.pj)\0*.pj?;*.pj;*.zip;";
...
void CMainMenu::OnSupportSwervito64(HWND hWnd)
{
...
bool CMainMenu::ProcessMessage(HWND hWnd, DWORD /*FromAccelerator*/, DWORD MenuID)
{
    ...
    case ID_CURRENT_SAVE_10:
        ...
        break;
    case ID_HELP_SUPPORT_Swervito64: OnSupportSwervito64(hWnd); break;
...
void CMainMenu::FillOutMenu(HMENU hMenu)
{
    ...
    HelpMenu.push_back(MENU_ITEM(ID_HELP_SUPPORT_Swervito64, MENU_SUPPORT_Swervito64));
