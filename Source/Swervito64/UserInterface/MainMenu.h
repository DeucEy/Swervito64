...
#include <Swervito64/Settings/UISettings.h>
#include <Swervito64/UserInterface/MenuItem.h>
#include <Swervito64/UserInterface/MenuShortCuts.h>
...
private:
    ...
    void OnSupportSwervito64(HWND hWnd);
