#pragma once
#include "resource.h"
#include <Swervito64\UserInterface\WTLControls\wtl-BitmapPicture.h>
...
public:
    BEGIN_MSG_MAP_EX(CSettingConfig)
    {
        ...
        COMMAND_ID_HANDLER(ID_SUPPORT_PJ64, OnSupportSwervito64);
...
private:
    ...
    LRESULT OnSupportSwervito64(WORD /*wNotifyCode*/, WORD wID, HWND /*hWndCtl*/, BOOL & /*bHandled*/);
