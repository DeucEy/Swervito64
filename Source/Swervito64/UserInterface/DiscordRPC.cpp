...
// Discord Swervito64 app ID
#define PJ64_DISCORD_APPID "1440169458185539594"
...
void CDiscord::Update(bool bHaveGame)
{
    ...
    if (artwork.empty())
    {
        ...
        discordPresence.largeImageText = "Swervito64";
    }
    else
    {
        ...
        discordPresence.smallImageText = "Swervito64";
    }
