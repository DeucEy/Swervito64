...
void init_textures()
{
    ...
    // (Comment by Ziggy) Because remove_tex isn't called (Swervito64 doesn't like it), it's better
...
{
#ifndef WIN32
    // (Comment by Ziggy) For some reason, Swervito64 doesn't like remove_tex on exit
