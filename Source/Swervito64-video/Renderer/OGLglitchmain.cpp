// Swervito64 - A Nintendo 64 emulator
// https://www.pj64-emu.com/
// Copyright(C) 2001-2021 Swervito64
// Copyright(C) 2003-2009 Sergey 'Gonetz' Lipski
// Copyright(C) 2002 Dave2001
// GNU/GPLv2 licensed: https://gnu.org/licenses/gpl-2.0.html

#include <Swervito64-video/Renderer/Renderer.h>
#include <Swervito64-video/Gfx_1.3.h>
...
#include <Swervito64-video/trace.h>
#include <Swervito64-video/Settings.h>
#include <Common/Util.h>

/*
`GetSystemSetting` and `FindSystemSettingId` from Swervito64 debugger
...
As of the Swervito64 Glide64 version, Glitch64 now assigns these OpenGL
...
bool gfxSstWinClose()
{
    ...
    free_textures();
#ifndef WIN32
    // (Comment by Ziggy) For some reasons, Swervito64 doesn't like remove_tex on exit
