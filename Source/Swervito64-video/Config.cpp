...
class CSwervito64VideoWtlModule :
    public CAppModule
{
public:
    CSwervito64VideoWtlModule(HINSTANCE hinst)
    {
        Init(nullptr, hinst);
    }
    virtual ~CSwervito64VideoWtlModule(void)
    {
        Term();
    }
};

CSwervito64VideoWtlModule * WtlModule = nullptr;

void ConfigInit(void * hinst)
{
    WtlModule = new CSwervito64VideoWtlModule((HINSTANCE)hinst);
}
