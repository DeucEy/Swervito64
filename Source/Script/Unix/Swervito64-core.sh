...
echo Compiling core sources for Swervito64...
...
echo Assembling Swervito64 core sources...
...
echo Linking static library objects for Swervito64-core...
ar rcs $obj/libSwervito64-core.a $OBJ_LIST
