...
#ifdef _WIN32
#include <Swervito64-audio/Driver/DirectSound.h>
#else
#include <Swervito64-audio/Driver/OpenSLES.h>
#endif
#include <Swervito64-plugin-spec/Audio.h>
#include "Version.h"
#include <stdio.h>
#include <string.h>
...
#ifdef _DEBUG
    sprintf(PluginInfo->Name, "Swervito64 audio plugin (Debug): %s", VER_FILE_VERSION_STR);
#else
    sprintf(PluginInfo->Name, "Swervito64 audio plugin: %s", VER_FILE_VERSION_STR);
#endif
