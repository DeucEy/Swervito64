...
#define DEF_STR(ID, str) m_DefaultStrings.insert(LANG_STRINGS::value_type(ID, str))
    ...
    DEF_STR(MENU_ABOUT_PJ64, "&About Swervito64");
    DEF_STR(MENU_WEBSITE, "&Website");
    DEF_STR(MENU_SUPPORT_Swervito64, "&Support Swervito64");
    ...
    DEF_STR(OPTION_CHECK_RUNNING, "Check if Swervito64 is already running");
    ...
    // Support window
    DEF_STR(MSG_SUPPORT_TITLE, "Support Swervito64");
    DEF_STR(MSG_SUPPORT_INFO, "Swervito64 is a free and open-source Nintendo 64 emulator. This allows you to play real Nintendo 64 software in much the same way as it would be on the original hardware.\n\nI am sorry about the inconvenience of this prompt, but you are being asked to wait for a few seconds in order to enjoy the result of hundreds of hours of work.\n\nIf you can and would like to support Swervito64 or you have gotten some value out of it then please support Swervito64 as either a thank you, or if you would like to see removal of this prompt.\n\nIf you have supported Swervito64:");
    DEF_STR(MSG_SUPPORT_ENTER_CODE, "Enter/Request Notification Code");
    DEF_STR(MSG_SUPPORT_Swervito64, "Support Swervito64");
    ...
    DEF_STR(MSG_SUPPORT_REQUESTCODE_FAIL, "Failed to send code, please make sure it is the email you used when you supported Swervito64");
    ...
    DEF_STR(ANDROID_ABOUT_APP_NAME, "Swervito64 for Android");
    DEF_STR(ANDROID_ABOUT_LICENCE, "License");
    DEF_STR(ANDROID_ABOUT_REVISION, "Revision");
    DEF_STR(ANDROID_ABOUT_TEXT, "Swervito64 for Android\u2122 is a port of the Windows version of Swervito64.The Android\u2122 version can play most N64 games.");
    DEF_STR(ANDROID_ABOUT_PJ64_AUTHORS, "Swervito64 Authors.");
    DEF_STR(ANDROID_DISCORD, "Discord");
    DEF_STR(ANDROID_SUPPORT_PJ64, "Support Swervito64");
    DEF_STR(ANDROID_REVIEW_PJ64, "Review Swervito64");
