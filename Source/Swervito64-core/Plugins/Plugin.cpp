...
static void LoadPlugin(SettingID PluginSettingID, SettingID PluginVerSettingID, plugin_type *& plugin, const char * PluginDir, stdstr & FileName, TraceModuleSwervito64 TraceLevel, const char * type, bool IsCopy)
{
    if (plugin != nullptr)
    {
        return;
