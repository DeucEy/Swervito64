...
#include <Swervito64-core/N64System/N64Types.h>
...
void CSettings::AddHowToHandleSetting(const char * BaseDirectory)
{
    ...
    AddHandler(SupportFile_SettingsDefault, new CSettingTypeRelativePath("Config", "Swervito64.cfg"));
    AddHandler(SupportFile_RomDatabase, new CSettingTypeApplicationPath("Settings", "RomDatabase", SupportFile_RomDatabaseDefault));
    AddHandler(SupportFile_RomDatabaseDefault, new CSettingTypeRelativePath("Config", "Swervito64.rdb"));
    ...
    AddHandler(SupportFile_NotesDefault, new CSettingTypeRelativePath("Config", "Swervito64.rdn"));
    AddHandler(SupportFile_ExtInfo, new CSettingTypeApplicationPath("Settings", "ExtInfo", SupportFile_ExtInfoDefault));
    AddHandler(SupportFile_ExtInfoDefault, new CSettingTypeRelativePath("Config", "Swervito64.rdx"));
    ...
    AddHandler(RomList_RomListCacheDefault, new CSettingTypeRelativePath("Config", "Swervito64.cache3"));
    ...
    AddHandler(RomList_7zipCacheDefault, new CSettingTypeRelativePath("Config", "Swervito64.zcache"));
...
#ifdef _WIN32
#ifdef _DEBUG
    AddHandler(Plugin_RSP_Current, new CSettingTypeApplication("Plugin", "RSP Dll", "RSP\\Swervito64-RSP_d.dll"));
    AddHandler(Plugin_GFX_Default, new CSettingTypeApplication("Plugin", "Graphics Dll Default", "GFX\\Swervito64-Video_d.dll"));
    AddHandler(Plugin_GFX_Current, new CSettingTypeApplication("Plugin", "Graphics Dll", Plugin_GFX_Default));
    AddHandler(Plugin_AUDIO_Current, new CSettingTypeApplication("Plugin", "Audio Dll", "Audio\\Swervito64-Audio_d.dll"));
    AddHandler(Plugin_CONT_Current, new CSettingTypeApplication("Plugin", "Controller Dll", "Input\\Swervito64-Input_d.dll"));
#else
    AddHandler(Plugin_RSP_Current, new CSettingTypeApplication("Plugin", "RSP Dll", "RSP\\Swervito64-RSP.dll"));
    AddHandler(Plugin_GFX_Default, new CSettingTypeApplication("Plugin", "Graphics Dll Default", "GFX\\Swervito64-Video.dll"));
    AddHandler(Plugin_GFX_Current, new CSettingTypeApplication("Plugin", "Graphics Dll", Plugin_GFX_Default));
    AddHandler(Plugin_AUDIO_Current, new CSettingTypeApplication("Plugin", "Audio Dll", "Audio\\Swervito64-Audio.dll"));
    AddHandler(Plugin_CONT_Current, new CSettingTypeApplication("Plugin", "Controller Dll", "Input\\Swervito64-Input.dll"));
#endif
#else
    AddHandler(Plugin_RSP_Current, new CSettingTypeApplication("Plugin", "RSP Dll", "libPlugin-rsp.so"));
    AddHandler(Plugin_GFX_Current, new CSettingTypeApplication("Plugin", "Graphics Dll", "libSwervito64-video.so"));
    AddHandler(Plugin_AUDIO_Current, new CSettingTypeApplication("Plugin", "Audio Dll", "libSwervito64-audio-android.so"));
    AddHandler(Plugin_CONT_Current, new CSettingTypeApplication("Plugin", "Controller Dll", "libSwervito64-input-android.so"));
#endif
