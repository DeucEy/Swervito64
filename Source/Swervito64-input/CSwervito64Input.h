...
public:
    CSwervito64Input(HINSTANCE hinst);
    ~CSwervito64Input();
...
private:
    CSwervito64Input();
    CSwervito64Input(const CSwervito64Input&);
    CSwervito64Input& operator=(const CSwervito64Input&);
...
extern CSwervito64Input * g_InputPlugin;
