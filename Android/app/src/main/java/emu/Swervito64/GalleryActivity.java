...
import emu.Swervito64.dialog.ProgressDialog;
import emu.Swervito64.game.GameActivity;
import emu.Swervito64.jni.LanguageStringID;
import emu.Swervito64.jni.NativeExports;
import emu.Swervito64.jni.SettingsID;
import emu.Swervito64.jni.UISettingID;
import emu.Swervito64.settings.GameSettingsActivity;
import emu.Swervito64.settings.SettingsActivity;
...
public class GalleryActivity extends AppCompatActivity
{
    ...
    private void StartGameMenu (boolean ShowSettings)
    {
        ...
        AlertDialog.Builder GameMenu = new AlertDialog.Builder(new ContextThemeWrapper(finalContext,R.style.Theme_Swervito64_Dialog_Alert));
