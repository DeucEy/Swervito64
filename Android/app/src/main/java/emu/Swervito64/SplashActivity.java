...
import emu.Swervito64.task.ExtractAssetZipTask;
import emu.Swervito64.task.ExtractAssetZipTask.ExtractAssetZipListener;
...
public class SplashActivity extends AppCompatActivity implements ExtractAssetZipListener, OnRequestPermissionsResultCallback
{
    ...
    private static final String SOURCE_DIR = "Swervito64_data";
    ...
    public void StartExtraction()
    {
        ...
        mInit = false;
        String ConfigFile = AndroidDevice.PACKAGE_DIRECTORY + "/Config/Swervito64.cfg";
    ...
    private void InitSwervito64()
    {
        ...
        String SaveDir = AndroidDevice.EXTERNAL_PUBLIC_DIRECTORY + "/Swervito64/Save";
        ...
        {
            String LogDir = AndroidDevice.EXTERNAL_PUBLIC_DIRECTORY + "/Swervito64/Logs";
        ...
        {
            String SnapShotDir = AndroidDevice.EXTERNAL_PUBLIC_DIRECTORY + "/Swervito64/Screenshots";
