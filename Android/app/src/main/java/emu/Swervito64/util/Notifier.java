...
public final class Notifier
{
    ...
    public static void DisplayError( Activity activity, String message )
    {
        ...
        sDisplayMessager = new Runnable()
        {
            ...
            public void run()
            {
                ...
                final AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(finalActivity,R.style.Theme_Swervito64_Dialog_Alert))
                .setView( layout)
                .setCancelable(false)
                .create();
    ...
    {
        /*((Swervito64Application) activity.getApplication()).getDefaultTracker().send(new HitBuilders.EventBuilder()
            .setCategory("game")
